...
const Project = ({title,link,subtitle})=>{
    ...
    return (
        ...
        >
            <a href={link} className="block hover:opacity-70 transition duration-500" target="_blank" rel="noreferre">
              <img className="rounded-tl-2xl rounded-tr-2xl" src={`../assets/${projectTitle}.png`} alt={`${title} - Shopify ${subtitle} by Muhammad Suleman Cheema`}/>
              <div className="flex justify-between items-center p-4">
                 ...
                 <div>
                    ...
                    <rect y="21.6981" width="0.999999" height="18" transform="rotate(-90 0 21.6981)" fill="#ffffff"></rect>
                    ...
                    stroke="#ffffff" strokeWidth="2" strokeLinecap="round"></path></svg>
                 </div>
